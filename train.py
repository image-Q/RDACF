...
if __name__ == "__main__":
    ...
    parser.add_argument('--use_interaction', action="store_true", help='if use interaction-aware predictor',
                        default=False)
    parser.add_argument('--sumo_gui', action="store_true", help='if use sumo gui', default=False) # 是否可视化
